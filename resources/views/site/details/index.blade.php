            ...
            <div class="row row-content">
                ...
                <div class="content-img">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="">
                            <img src="{{ asset('assets/painel/img/' . $product[0]->image) }}" alt="" class="img-responsive">
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="container">
                <div class="form-group header">
                    <h2 class="text-dark">{{ $product[0]->name ." / ". $product[0]->description }}</h2>
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        @foreach ($product->unique('size') as $item)
                                            @if($item->quantity_item > 0)
                                                <label for="" class="btn btn-primary ml-3" >{{ $item->size }}
