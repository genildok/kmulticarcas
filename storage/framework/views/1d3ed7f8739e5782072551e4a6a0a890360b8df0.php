    ...
    <div class="header-top d-lg-block d-md-block d-none ">
      ...
      <div class="menu-action">
        <ul class="nav justify-content-center justify-content-lg-end justify-content-md-end">
          <li class="nav-item">
            <a class="nav-link text-light" href="<?php echo e(url('/cart')); ?>">
              <i class="fa  fa-shopping-cart" aria-hidden="true"></i>
              <i class="badge badge-pill badge-danger float-right icon-status-cart">2</i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="<?php echo e(url('/login')); ?>">
              <span class="d-block ">Login</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="<?php echo e(url('/profile')); ?>">Meu dados</a>
          </li>
        </ul>
    ...
    <nav class="navbar navbar-expand-md  navbar-light menu-bar-bottom">
      ...
      <div class="collapse navbar-collapse menu-bar-top" id="collapsibleNavId">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('/sales')); ?>">Ofertas</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('/news')); ?>">Novidades</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownId">
              <a class="dropdown-item" href="<?php echo e(url('/brand',[01])); ?>">Nike</a>
              <a class="dropdown-item" href="<?php echo e(url('/brand',[02])); ?>">Reserva</a>
              <a class="dropdown-item" href="<?php echo e(url('/brand',[03])); ?>">Adidas</a>
            </div>
          </li>
          <li class="nav-item">
        ...
        <!-- Form search -->
        <form action="<?php echo e(url('/product/search')); ?>" class="form-inline form-search" method="POST">
